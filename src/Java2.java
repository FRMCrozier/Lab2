...
public class Java2 {
    ...
    /**
     * Первое задание под вариантом 26 (номер по списку 3, номер группы 191):
    ...
    /**
     * Второе задание под вариантом 51 (номер по списку 3, номер группы 191):
    ...
    /**
     * Третье задание под вариантом 76 (номер по списку 3, номер группы 191):
    ...
    /**
     * Четвертое задание под вариантом 101 (номер по списку 3, номер группы 191):
    ...
    /**
     * Пятое задание под вариантом 126 (номер по списку 3, номер группы 191):
